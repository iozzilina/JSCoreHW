...
Define several JS classes, that represent a company’s employee records. 
...
Place all common functionality in a parent abstract class. Follow the diagram bellow:
...
for that position and prints the current one. When all tasks have been printed, the list starts 
over from the beginning. Employees can also collect salary, which outputs the amount, plus any bonuses.
...
shared among the different positions. Looking at the problem description, 
we see the following structure for our parent object:
